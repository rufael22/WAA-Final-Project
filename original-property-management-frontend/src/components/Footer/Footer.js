          ...
          <div className="row">
            <div className="col-lg-3 col-xs-3 col-sm-6">
              <div className="single-footer-widget footer-logo-widget">
                <div className="footer-widget-text">
                  <p>
                  At MOM Real Estate, you are number one. Whether you are a tenant, or buyer, we value your business and will provide you with the individual attention and service you deserve. We believe in integrity, commitment to excellence, a professional attitude, and personalized care.
                  </p>
            ...
            <div className="col-lg-3 col-xs-3 col-sm-6">
              <div className="single-footer-widget">
                ...
                <ul className="quicklinks">
                  <li>
                    <Link to="/" style={{ color: "black" }}>
                      <i className="fa fa-angle-double-right "></i> About mom
                      forum
                    </Link>
                  </li>
                  <li>
            ...
            <div className="col-lg-3 col-xs-3 col-sm-6">
              <div className="single-footer-widget">
                <h3>Contact Info</h3>
                <p>
                  <i className="fa fa-map-marker"></i> 4th North Street, Fairfield,
                  USA{" "}
                </p>
                <p>
                ...
                <p>
                  <i className="fa fa-envelope-o"></i> info@mom.com
                </p>
                <p>
                  <i className="fa fa-envelope-o"></i> info@mom.com
                </p>
